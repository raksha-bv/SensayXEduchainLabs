...
export class TelegramIntegrationService {
     ...
     * @throws ApiError
     */
    public getV1ReplicasChatHistoryTelegram(
     ...
     * @throws ApiError
     */
    public postV1ReplicasChatHistoryTelegram(
        replicaUuid: replicaUUID_parameter,
        requestBody?: {
            /**
     ...
     * @throws ApiError
     */
    public postV1ReplicasChatCompletionsTelegram(
        replicaUuid: replicaUUID_parameter,
        requestBody?: {
            /**
     ...
     * @throws ApiError
     */
    public postV1ReplicasIntegrationsTelegram(
        replicaUuid: replicaUUID_parameter,
     ...
     * @throws ApiError
     */
    public deleteV1ReplicasIntegrationsTelegram(
        replicaUuid: replicaUUID_parameter,
        xApiVersion: string = '2025-03-25',
    ): CancelablePromise<{
        /**
