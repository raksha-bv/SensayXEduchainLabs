...
export class TrainingService {
     ...
     * @throws ApiError
     */
    public getV1ReplicasTrainingFilesUpload(
        replicaUuid: replicaUUID_parameter,
        filename: string,
    ): CancelablePromise<{
        /**
